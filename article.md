...
7. **Выявить зависимость качества** написания промта.  
   1. Насколько хорошо нужно прописывать техническое задание для нейросети.  
   2. От чего зависит качество написанного технического задания.
...
Также вы можете дополнительно посмотреть исследование влияние ИИ на занятость: [https://digitaleconomy.stanford.edu/wp-content/uploads/2025/08/Canaries\_BrynjolfssonChandarChen.pdf](https://digitaleconomy.stanford.edu/wp-content/uploads/2025/08/Canaries_BrynjolfssonChandarChen.pdf).
